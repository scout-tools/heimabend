# Generated by Django 3.2 on 2021-04-29 21:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='event',
            name='header_image',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='basic.image'),
        ),
        migrations.AddField(
            model_name='event',
            name='material_items',
            field=models.ManyToManyField(blank=True, to='basic.MaterialItem'),
        ),
        migrations.AddField(
            model_name='event',
            name='tags',
